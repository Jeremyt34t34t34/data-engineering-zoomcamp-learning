...
columns:
  ...
  - name: fare_amount
    type: double
    description: Non-negative fare amount
    checks:
      - name: non_negative
...
custom_checks:
  - name: row_count_greater_than_zero
    description: The staging window should produce at least one row
    query: |
...
QUALIFY ROW_NUMBER() OVER (
    PARTITION BY t.pickup_datetime, t.dropoff_datetime, t.pickup_location_id,
                 t.dropoff_location_id, t.fare_amount, t.taxi_type
